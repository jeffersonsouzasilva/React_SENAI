...
function Home() {
    ...
    //tem erro ao chamar mostrar menu, pois tinha que apagar por conta do Header da pasta de components
    ...
    return (
      ...
      *}
                        <a
                            ...
                            aria-haspopup="true"
                            onClick={ mostrarMenu } //em reat pode fazer uma chamada em eventos sem precisar acrescentar parenteses
                            href="#"
                        >
