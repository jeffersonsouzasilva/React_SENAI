...
function Login() {
    ...
    function fazerLogin(event: any){
        ...
        api.post("login", usuario).then((response) => {
            console.log(response) // gerar um token para acessar a plataforma (acess token)
                    ...
                    <form onSubmit={fazerLogin} className="login_formulario" method="POST">
                        <div className="login_box_input">
                            ...
                            <input
                                type="email"
                                id="email"
                                onChange={(event) => setEmail(event.target.value)} //acrescentado
                        ...
                        <div className="login_box_input">
                            ...
                            <input
                                type="password"
                                id="senha"
                                onChange={(event) => setSenha(event.target.value)} //acrescentado
